class ApplicationController < ActionController::Base
  ...
  protected
    def layout_by_resource
      if controller_name == "home" || controller_name == "contact" || controller_name == "category" || controller_name == "product" || controller_name == "cart" || controller_name == "blog"
        "frontend"
        ...
        "login"
            ...
            controller_name == "options" || controller_name == "users" || controller_name == "user_groups" || controller_name == "contacts" || controller_name == "newsletters" || controller_name == "projects" || controller_name == "project_categories" || controller_name == "program_languages"
