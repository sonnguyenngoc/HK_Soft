    ...
    def layout_by_resource
      if controller_name == "home" || controller_name == "about_us" || controller_name == "tour" || controller_name == "event" || controller_name == "car_hire" || controller_name == "book_hotel" || controller_name == "tour_handbook" || controller_name == "travel_news" || controller_name == "info" || controller_name == "service" || controller_name == "contact" || controller_name == "hot_tours" || controller_name == "tour_group"
        ...
        "login"
            ...
            controller_name == "booking_cars" || controller_name == "booking_hotels" || controller_name == "booking_planes" || controller_name == "booking_tours" || controller_name == "booking_visas" || controller_name == "galleries" || controller_name == "tour_groups" || controller_name == "quick_booking_hotels" || controller_name == "countries" || controller_name == "visas"
          authenticate_user!
