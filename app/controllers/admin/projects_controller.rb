class Admin::ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:image_url, :project_type, :author, :author_vi, :name, :name_vi, :start_date, :end_date, :description, :description_vi, :website, project_images_attributes: [:id, :image_url, :_destroy])
    end
end