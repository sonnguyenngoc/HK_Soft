class Admin::ToursController < ApplicationController
  ...
  private
    ...
    def tour_params
      params.require(:tour).permit(:published_at, :label, :file_tour, :image_url, :tab_content_1, :tab_content_2, :tab_content_3, :tab_content_4, :meta_keywords, :meta_description,
