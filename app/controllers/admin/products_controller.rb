class Admin::ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:real_stock, :is_show, :stock, :name, :code, :quantity, :unit, :price, :old_price, :colors, :made_in, :discount_percent, :tags, :short_description, :description, :status, :manufacturer_id, :product_image_id, :meta_keywords, :meta_description, product_images_attributes: [:id, :image_url, :is_main, :_destroy])
    end
end
